...
- Added [](https://github.com/AskitEndo/DSA-Excercise/blob/main/Codes/):Question Description[Link to Question❓](https://leetcode.com/problems/)
...
- Added [firstMissingPositive_Better.cpp](https://github.com/AskitEndo/DSA-Excercise/blob/main/Codes/Day%2047/firstMissingPositive_Better.cpp):Given an unsorted integer array nums. Return the smallest positive integer that is not present in nums.[Link to Question❓](https://leetcode.com/problems/first-missing-positive/description/)

- Added [firstMissingPositive_Optimal.cpp](https://github.com/AskitEndo/DSA-Excercise/blob/main/Codes/Day%2047/firstMissingPositive_Optimal.cpp):Given an unsorted integer array nums. Return the smallest positive integer that is not present in nums.[Link to Question❓](https://leetcode.com/problems/first-missing-positive/description/)
...
- Added [numSubarrayBoundedMax.cpp](https://github.com/AskitEndo/DSA-Excercise/blob/main/Codes/Day%2046/numSubarrayBoundedMax.cpp):Given an array of integers A, and two integers L and R, subarray element in that subarray is at least L and at most R.[Link to Question❓](https://leetcode.com/problems/max-chunks-to-make-sorted-ii/)
...
- Added [kokoBananas.cpp](https://github.com/AskitEndo/DSA-Excercise/blob/main/Codes/Day%2045/kokoBananas.cpp): There are n piles of bananas, the ith pile has piles[i] bananas. The guards have gone and will come back in h hours.[Link to Question❓](https://leetcode.com/problems/koko-eating-bananas/description/)
...
- Added [largestSubArrayWith0Sum.cpp](https://github.com/AskitEndo/DSA-Excercise/blob/main/Codes/Day%2031/largestSubArrayWith0Sum.cpp):Givnig the largest subarray wth sum 0, similar to kadane algorithm[Link to Question❓](https://www.geeksforgeeks.org/problems/largest-subarray-with-0-sum/1)
...
- Added [sumArrayOfSumK_HashMap.cpp](https://github.com/AskitEndo/DSA-Excercise/blob/main/Codes/Day%2014/sumArrayOfSumK_HashMap.cpp): Returns the len of the longest number of elements to sum up to k.[Link to Question❓](https://www.geeksforgeeks.org/problems/longest-sub-array-with-sum-k0809/1)
...
- Added [checkFactorial.cpp](https://github.com/AskitEndo/DSA-Excercise/blob/main/Codes/Day%206/checkFactorial.cpp): returns array containing all factorial numbers which are less than/equal to ‘n’. [Link to Question❓](https://www.naukri.com/code360/problems/factorial-numbers-not-greater-than-n_8365435)
...
- Added [](https://github.com/AskitEndo/DSA-Excercise/blob/main/Codes/):[Link to Question❓](https://leetcode.com/problems/)
